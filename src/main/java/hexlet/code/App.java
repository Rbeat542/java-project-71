...
class App implements Callable<Integer> {
	...
	@Parameters(description = "path to first file", defaultValue = "/home/vboxuser/java-project-71/app/src/main/java/hexlet/code/file1.json", paramLabel = "filepath1" )
	private File file1 = new File("file1,json");

	@Parameters(description = "path to second file", defaultValue = "/home/vboxuser/java-project-71/app/src/main/java/hexlet/code/file2.json", paramLabel = "filepath2")
	...
	public Integer call() throws Exception {
		...
		Map<String, Object> json1 = mapSort(mapper.readValue(file1Contents, new TypeReference<Map<String, Object>>() { } ));
		Map<String, Object> json2 = mapSort(mapper.readValue(file2Contents, new TypeReference<Map<String, Object>>() { } ));
		...
		for (var entry2 : entries2) {
			...
			} else resultMapUnsorted.add("  + " + entry2.getKey() + ": " + entry2.getValue());
		}
